    ...
    */
        ...
        static public bool TeleportQuick(Player Plr, ref List<string> Values)
        {
            ...
            switch (location)
            {
                ...
                //*****************************Scenarios
                case "nh":
                case "nordenwatch": { ZoneID = 130; WorldX = 364390; WorldY = 360091; WorldZ = 3571; break; } // nordenwatch
                ...
                case "tlv":
                case "the lost vale": { ZoneID = 260; WorldX = 1410100; WorldY = 1588397; WorldZ = 5829; break; } // the lost vale

                case "md":
                case "mount gunbad": { ZoneID = 60; WorldX = 851898; WorldY = 848602; WorldZ = 28908; break; } // mount gunbad

                case "ss":
                case "sigmar crypts": { ZoneID = 176; WorldX = 1499382; WorldY = 218141; WorldZ = 8612; break; } // sigmar crypts
                ...
                case "he":
                case "hunters vale": { ZoneID = 50; WorldX = 316709; WorldY = 528087; WorldZ = 4330; break; } // hunters vale
                case "ws":

                case "tn":
                case "thanquol's incursion": { ZoneID = 410; WorldX = 86363; WorldY = 88270; WorldZ = 8794; break; } // thanquol's incursion

                case "ws2":
                case "warpblade tunnels 2": { ZoneID = 154; WorldX = 211441; WorldY = 200079; WorldZ = 9136; break; } // warpblade tunnels 2

                case "ts":
                case "the Sacellum": { ZoneID = 159; WorldX = 196468; WorldY = 193160; WorldZ = 17408; break; } // the Sacellum

                case "tr":
                case "Temple of Sigmar": { ZoneID = 157; WorldX = 188820; WorldY = 199036; WorldZ = 12608; break; } // Temple of Sigmar
         ...
         //   Log.Command = "TELEPORT TO " + ZoneID + " " + ZoneX + " " + ZoneY;
