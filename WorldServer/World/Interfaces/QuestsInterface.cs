...
namespace WorldServer
{
    public class QuestsInterface : BaseInterface
    {
        ...
        public Boolean HasQuestInteract(Player Plr, Creature Crea)
        {
            if (Entry == 0)
                return false;
            ...
            string Text = WorldMgr.GetCreatureText(Entry);// added mite not need
        ...
        private PQuestObject pq;

        public PQuestObject GetPublicQuest()
        {
            return pq;
        }
