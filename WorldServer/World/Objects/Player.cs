/*leo228
 * Copyright (C)Dawn of Reckoning project 2008-2019
 */
...
namespace WorldServer
{
    public class Player : Unit
    {
        ...
        public void SendUpdateState()
        {
            ...
            // EMPIRE
            // THIS NEEDS TO GET THE AREA IDS I THINK WHICH SENDS TURNS ON INFLUNCE BAR
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteByte(0);
            Out.WriteUInt16(0x2E11);
            Out.WriteByte(2);
            Out.WriteByte(1);
            Out.Fill(0, 5);
            SendPacket(Out);
            ...
            /// testing this one in gunbad
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteByte(0);
            Out.WriteUInt16(0x1F11);
            Out.WriteByte(2);
            Out.WriteByte(1);
            Out.Fill(0, 5);
            SendPacket(Out);
            ...
            // testing this one in gunbad
            Out = new PacketOut((byte)Opcodes.F_INFLUENCE_DETAILS);
            Out.WriteUInt16(0x0040);
            SendPacket(Out);
            ...
            // 00 4F 11 02 01 00 00 00 00 00
            // empire for troll and ostland area
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteByte(0);
            Out.WriteUInt16(0x4F11);// =79
            Out.WriteByte(2);
            Out.WriteByte(1);
            Out.Fill(0, 5);
            SendPacket(Out);
            ...
            //high elfs  // DARK ELVES ??
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteByte(0);
            Out.WriteUInt16(0x3D11);
            Out.WriteByte(2);
            Out.WriteByte(1);
            Out.Fill(0, 5);
            SendPacket(Out);
            ...
            //empire chapter 18 ? pragg
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteByte(0);
            Out.WriteUInt16(0x4D11);
            Out.WriteByte(2);
            Out.WriteByte(1);
            Out.Fill(0, 5);
            SendPacket(Out);
            ...
            // grimminhagen cotested// on its own nordland constested
            Out = new PacketOut((byte)Opcodes.F_UPDATE_STATE);
            Out.WriteUInt16(Zone.Info.ZoneId);
            Out.WriteByte(0x11);
            Out.WriteByte(1);
            Out.WriteByte(1);
            Out.WriteByte(0);
